...
void PostgreSQLLexerBase::HandleNumericFail()
{
	...
	this->setType(stewkk::sql::codegen::PostgreSQLLexer::Integral);
}

void PostgreSQLLexerBase::HandleLessLessGreaterGreater()
{
	if (this->getText() == "<<") this->setType(stewkk::sql::codegen::PostgreSQLLexer::LESS_LESS);
	if (this->getText() == ">>") this->setType(stewkk::sql::codegen::PostgreSQLLexer::GREATER_GREATER);
}
