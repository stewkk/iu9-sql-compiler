...
\begin{enumerate}
  ...
  \item Внутренний подзапрос
        ...
        \]
        \noindent{} Подзапрос коррелирован, так как зависит от атрибута \(e.\text{dept}\)
        внешнего кортежа.
...
\caption{Недостижимый физический план Microsoft SQL Server после конвертации.}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{reach-fuzz-cross-ours.pdf}
\caption{Физический план, построенный модельной СУБД для того же запроса.}
...
запросов на том же наборе данных. Видно, что оптимизатор дает ускорение в $2$ и
более раз а на накоторых запросах в $30$ раз.
