...
По базовому правилу оба вхождения таблицы остаются как есть
...
Для операторов \(\FilterOp\) и \(\ProjOp\) стоимость ввода-вывода равна \(0\),
потому что это конвейерные операторы, которые не используют диск.
...
табилце~\ref{tbl:cost-model-coefficients}. Кардинальность базовых отношений
